...
export const Content = () => {
  ...
  const handleSignTypedDataV4 = async () => {
    ...
    console.log('🚀 ~ file: index.tsx:200 ~ handleSignTypeDataV4 ~ res SignTypeDataV4:', res);
  };
  ...
  const handleSignTypedData = async () => {
    ...
    console.log('🚀 ~ file: index.tsx:200 ~ handleSignTypeData ~ res SignTypeData:', res);
  };
  const handleSignTypedDataV3 = async () => {
    ...
    console.log('🚀 ~ file: index.tsx:200 ~ handleSignTypeDataV3 ~ res SignTypeDataV3:', res);
  };
  useEffect(() => {
    (async () => {
