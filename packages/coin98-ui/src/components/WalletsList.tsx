...
const WalletsList = ({
  ...
  return (
    <div className="c98-w-full lg:c98-w-[488px] c98-flex c98-flex-col">
      <h3 className="c98-text-subTitle c98-hidden lg:c98-block c98-text-[16px] c98-font-medium">2. {titleWallets}</h3>
      <div className="c98-overflow-y-auto c98-w-full c98-mt-[12px] c98-bg-bkg-secondary c98-rounded-[16px] c98-flex-1 c98-max-h-[334px]">
...
const ListWaleltContent = ({
  ...
  // useEffect(() => {
  //   if (isNotInstalled && !walletActive) {
  //     requestInstall(false);
  //   }
  // }, [isNotInstalled, requestInstall, walletActive]);
  if (isNotInstalled && walletActive)
    return (
      <div>
  ...
  return (
    ...
    >
      <div className="c98-relative">
        {isConnecting && (
          <div className="c98-w-[40px] c98-h-[40px] c98-absolute c98-inset-0 center-all c98-mx-auto c98-my-auto c98-z-10">
            <Player src={require('../images/loading98.json')} className="c98-w-[80px] c98-h-[80px]" loop autoplay />
          </div>
        )}

        {isConnecting && (
          <div className="c98-w-[40px] c98-absolute c98-h-[40px] c98-inset-0 c98-bg-bkg-secondary c98-mx-auto c98-my-auto c98-opacity-60" />
        )}
