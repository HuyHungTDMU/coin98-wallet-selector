...
import {bsc, ether, seiNetwork, solana, tomo} from './chainsData';
...
export const WalletModalC98: FC<WalletModalC98Props> = props => {
    const {
        enableChains = [ether, bsc, solana, seiNetwork, tomo],
        activeChainId,
    ...
    const [selectedNetwork, setSelectedNetwork] = useState<{ blockChainName: string; chainId: string }>(
    ...
    const handleSelectedChain = (blockChainName: string, chainId: string) => {
        setSelectedNetwork({blockChainName, chainId});
    };
