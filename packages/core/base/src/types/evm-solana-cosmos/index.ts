import type { WalletAdapterCosmos, WalletAdapterEVM, WalletAdapterNear, WalletAdapterSolana } from '../../adapter.js';
import type {
  FullySignerWalletAdapterEVM,
  MessageSignerWalletAdapterCosmos,
  MessageSignerWalletAdapterEVM,
  MessageSignerWalletAdapterNear,
...
export type Adapter = AdapterSolana | AdapterEVM | AdapterCosmos | AdapterNear;
export type AdapterSolana =
  | WalletAdapterSolana
  | SignerWalletAdapterSolana
  | MessageSignerWalletAdapterSolana
  | StandardWalletAdapter;
export type AdapterEVM = WalletAdapterEVM | MessageSignerWalletAdapterEVM | FullySignerWalletAdapterEVM;

export type AdapterCosmos = WalletAdapterCosmos | MessageSignerWalletAdapterCosmos;
export type AdapterNear = WalletAdapterNear | MessageSignerWalletAdapterNear;
...
export interface WatchAssetType {
  type: string;
  options: {
    address: string;
    symbol?: string;
