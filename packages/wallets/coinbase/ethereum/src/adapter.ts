...
export const CoinbaseName = 'Coinbase' as WalletName<'Coinbase'>;

export class CoinbaseAdapterEthereum extends BaseMessageSignerWalletAdapterEVM {
  id = 'coinbase_ether';
  chain = 'evm';
  name = CoinbaseName;
  url = 'https://www.coinbase.com/fr/wallet/downloads';
  icon = iconUrl;
  private _wallet: Coinbase | null;
  ...
  async autoConnect() {
    try {
      ...
      const wallet = window.coinbaseWalletExtension!;
      let address: string;
