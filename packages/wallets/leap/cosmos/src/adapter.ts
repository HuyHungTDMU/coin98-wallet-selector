...
interface LeapWalletEvents {
  connect(...args: unknown[]): unknown;
  disconnect(...args: unknown[]): unknown;
  leap_keystorechange(...args: unknown[]): unknown;
}

interface LeapWallet extends EventEmitter<LeapWalletEvents> {
...
export const LeapWalletName = 'Leap' as WalletName<'Leap'>;

export class LeapWalletAdapterCosmos extends BaseMessageSignerWalletAdapterCosmos {
  id = 'leap_cosmos';
  chain = 'cosmos';
  name = LeapWalletName;
  ...
  private _rejectMatched(e: Error) {
    return leapExtensionInfo.rejectMessage.source === e.message;
  }
}
