...
// options to init
// network to generate to requiredNamespaces use in connect, find sessions, call request
// When call request must assign network and topic
// topic to identify client wallet, event changeaccount get new topic, when you can get new session with new that topic
